...
{
    internal class WriteMultipleRegisters32Request : AbstractModbusMessageWithData<RegisterCollection>, IModbusRequest
    {
        public WriteMultipleRegisters32Request()
        {
        }

        public WriteMultipleRegisters32Request(byte slaveAddress, ushort startAddress, RegisterCollection data)
            : base(slaveAddress, ModbusFunctionCodes.WriteMultipleRegisters)
        {
            StartAddress = startAddress;
            NumberOfPoints = (ushort)(data.Count / 2);
