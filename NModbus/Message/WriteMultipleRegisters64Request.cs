...
{
    internal class WriteMultipleRegisters64Request : AbstractModbusMessageWithData<RegisterCollection>, IModbusRequest
    {
        public WriteMultipleRegisters64Request()
        {
        }

        public WriteMultipleRegisters64Request(byte slaveAddress, ushort startAddress, RegisterCollection data)
            : base(slaveAddress, ModbusFunctionCodes.WriteMultipleRegisters)
        {
            StartAddress = startAddress;
            NumberOfPoints = (ushort)(data.Count / 4);
